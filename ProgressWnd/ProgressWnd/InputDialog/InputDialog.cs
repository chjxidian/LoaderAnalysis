...
namespace ProgressWnd
{
    public class InputDialog : Form
    {
        ...
        private InputDialog()
        {
            ...
            btnCancel.ForeColor = Color.White; //Color.FromArgb(170, 170, 170);
            ...
            btnOK.Text = "OK";
            btnOK.ForeColor = Color.White; //Color.FromArgb(170, 170, 170);
        ...
        private InputDialog(String postiveText, String nagtiveText)
        {
            Panel pl = new Panel();
            pl.Dock = DockStyle.Fill;
        ...
        private InputDialog(String postiveText, String nagtiveText, Color backColor)
        {
            Panel pl = new Panel();
            pl.Dock = DockStyle.Fill;
            ...
            this.Controls.Add(flpButtons);
            this.FormBorderStyle = FormBorderStyle.None;
            this.BackColor = backColor; //Color.FromArgb(45, 45, 48);
            this.StartPosition = FormStartPosition.CenterScreen;
            this.Padding = new Padding(20);
            this.Width = 400;
            this.Height = 200;
        ...
        {
            InputDialog dialog = new InputDialog("确定", "取消");
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(Color.Gray);//Color.FromArgb(0, 151, 251)
